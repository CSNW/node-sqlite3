...
Database.prototype.allSync = function(sql) {
    var params = Array.prototype.slice.call(arguments, 1);
    var statement = new Statement(this, sql, errorCallback(params), new Boolean(true));
...
sqlite3.verbose = function() {
    if (!isVerbose) {
        ...
        trace.extendTrace(Database.prototype, 'allSync');
        ...
        trace.extendTrace(Statement.prototype, 'allSync');
